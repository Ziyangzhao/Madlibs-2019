<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST"){
		foreach ($Answers as $key => $awnserValue) {
			if (empty($_POST[$key])){
			    $Err[$key] = "Je moet iets invullen";
			    $errors++;
			}else{
				$Answers[$key] = test_input($_POST[$key]);
...
<body>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
		<fieldset>
			...
			<div>
				...
				<input type="text" name="<?php echo $key ?>" value="<?php echo $Answers["$key"];?>">
	...
	<?php } else{?>
		<div id="text" style="background-color: white; width: 75vw; margin: 0 auto; padding-left: 5vw;padding-top: 4vh; padding-bottom: 4vh;">
			...
			<p>Er heerst paniek in het koninkrijk <?php echo $Answers["Q3"] ?>. Koning <?php echo $Answers["Q6"] ?> is ten einde raad en als koning <?php echo $Answers["Q6"] ?>  ten einde raad is, dan roept hij zijn ten-einde-raadsheer <?php echo $Answers["Q2"] ?>.</p></br>
			<p>"<?php echo $Answers["Q2"] ?>! het is een ramp! Het is een schande!"</p></br>
			<p>"Sire!, Majesteit, Uwe Luidruchtigheid, wat is er aan de hand?"</p></br>
			<p>"Mijn <?php echo $Answers["Q1"] ?> is verdwenen! Zo maar, zonder waarschuwing. En ik had net <?php echo $Answers["Q5"] ?> voor hem gekocht!"</p></br>
			<p>"Majesteit, uw <?php echo $Answers["Q1"] ?> komt vanzelf weer terug?"</p></br>
			<p>"Ja, da's leuk en aardig, maar hoe moet ik in de tussentijd <?php echo $Answers["Q8"] ?> leren?"</p></br>
			<p>"Maar Sire, daar kunt u toch uw <?php echo $Answers["Q7"] ?> voor gebruiken."</p></br>
			<p>"<?php echo $Answers["Q2"] ?>, je hebt helemaal gelijk! Wat zou ik doen als ik jou niet had."</p></br>
			<p>"<?php echo $Answers["Q4"] ?>, Sire."</p>
		</div>
	<?php } 
