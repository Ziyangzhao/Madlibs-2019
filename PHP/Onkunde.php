...
<body>
		...
		<?php foreach ($Questions as $key => $questionValue) { ?>
	 	 <div class="form-group">
	  		<div class="col-4">
		   	...
		   	<div class="col-3">
		   		<input type="text" class="form-control" name="<?php echo $key ?>" placeholder="Text..." value="<?php echo $Answers["$key"];?>">
	...
	<?php } else{?>
		<div id="text" style="background-color: white; width: 80vw; margin: 0 auto; padding-left: 5vw;padding-top: 4vh; padding-bottom: 4vh;">
			<h1>Onkunde</h1>
			<p>Er zijn veel mensen die niet kunnen <?php echo $Answers["Q1"] ?>. Neem nou <?php echo $Answers["Q2"] ?>. Zelfs met de hulp van een <?php echo $Answers["Q4"] ?> of zelfs <?php echo $Answers["Q3"] ?> kan <?php echo $Answers["Q2"] ?> niet <?php echo $Answers["Q1"] ?>. Dat heeft niet te maken met een gebrek aan <?php echo $Answers["Q5"] ?>, maar met een te veel aan <?php echo $Answers["Q6"] ?>. Te veel <?php echo $Answers["Q6"] ?> leidt tot <?php echo $Answers["Q7"] ?> en dat is niet goed als je wilt <?php echo $Answers["Q1"] ?>. Helaas voor <?php echo $Answers["Q2"] ?></p>
		</div>
	<?php } ?>
